...
from networks.bodymesh.batch_smpl import SMPL, batch_orth_proj_idrot
...
class HumanModelRecovery(nn.Module):
    ...
    def __init__(self, smpl_data, feature_dim=2048, theta_dim=85, iterations=3):
        ...
        # define smpl
        self.smpl = SMPL(smpl_data=smpl_data)
    ...
    def forward(self, inputs):
        ...
        thetas = self.regressor(features)  # regressor results
        return thetas

    def skin_blend(self, theta, get_rs=False):
    ...
    def get_details(self, theta, get_rs=False):
        """
            purpose:
        ...
        detail_info = self.skin_blend(theta, get_rs=get_rs)
        detail_info['theta'] = theta
