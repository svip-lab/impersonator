            ...
            for target_name, synthesis_results in frame_result.items():
                ...
                for synthesis_result, synthesis_result_2, synthesis_result_3, synthesis_result_4 in zip(synthesis_results, synthesis_results_2,
                    ...
                    args_list.append(([frame_img_path, target_img_path,
                                       synthesis_img_path,
                                       synthesis_img_path_2,
                                       synthesis_img_path_3,
                                       synthesis_img_path_4],
                                      [frame_img_path.replace(result_root_path1, ''), target_img_path.replace(result_root_path1, ''),
                                       'ours' + synthesis_img_path.replace(result_root_path1, ''),
                                       'pG2' + synthesis_img_path_2.replace(result_root_path2, ''),
                                       'SHUP' + synthesis_img_path_3.replace(result_root_path3, ''),
                                       'DSC' + synthesis_img_path_4.replace(result_root_path4, '')
                                       ]))
...
def create_four_dataset_result():
    result_root_path_1 = '/p300/poseGANs/impersonator_02_29_smooth'     # ours
    result_root_path_2 = '/p300/poseGANs/pG2/results'                   # pG2
    result_root_path_3 = '/p300/poseGANs/posewarp/mi_results_10000_preview' # SHUP
    result_root_path_4 = '/p300/poseGANs/concat_30_v2'                      # DSC
    # result_root_path_4 = '/p300/poseGANs/concat_30_v2'
    # result_root_path_4 = '/p300/poseGANs/feature_warping_5_smooth'

    # result_root_path_1 = '/p300/poseGANs/impersonator_02_29'
    # result_root_path_2 = '/p300/poseGANs/pG2/results'
    # result_root_path_3 = '/p300/poseGANs/impersonator_02_29'
    # result_root_path_4 = '/p300/poseGANs/impersonator_02_29'

    save_video_name = 'MI_ours_pG2_shup_dsc_final'

    fourcc = cv2.VideoWriter_fourcc(*'XVID')
    fused_w, fused_h = 256 * 3, 256 * 2
    save_prefix_path = '/p300/poseGANs/demos'
    fps = 4
    pool_size = 50
...
def show_four_dataset_result():
    import ipdb
    result_root_path_1 = '/p300/poseGANs/impersonator_02_29'
    result_root_path_2 = '/p300/poseGANs/pG2/results'
    result_root_path_3 = '/p300/poseGANs/posewarp/mi_results_10000_preview'
    result_root_path_4 = '/p300/poseGANs/concat_30_v2'

    save_video_name = 'MI_ours_pG2_shup_dsc'
