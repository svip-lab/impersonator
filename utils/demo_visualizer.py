...
def convert_to_obj(vertices, faces):
...
class MotionImitationVisualizer(Visualizer):

    def __init__(self, env, time_step=1, num_points=18,
                 ip=None, port=None):
        super(MotionImitationVisualizer, self).__init__(env, ip=ip, port=port)
