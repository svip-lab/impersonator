...
def front_face_mapping(nf, front_face_info):
    half_nf = nf // 2
...
def create_mapping(map_name, mapping_path='pretrains/uv_mappings.txt', part_info='pretrains/smpl_part_info.json',
    ...
    if map_name == 'uv':
        ...
        map_fn, bg = front_face_mapping(nf, front_info)
    elif map_name == 'head':
        map_fn, bg = front_face_mapping(nf, head_info)
    elif map_name == 'ids':
